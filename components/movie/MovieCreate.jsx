...
const MovieCreate = ({ id }) => {
  ...
  useEffect(() => {
    // Check if window is defined to ensure you are on the client side
  ...
  useEffect(() => {
    const getOneMovie = async () => {
      try {
        ...
        setFile(response.data.result.image.name)
      } catch (error) {
        ...
        <div className="movieform">
          ...
          <div>
            ...
            <div className="buttonsection">
              <Link href="/movies"><button className="cancelbutton">Cancel</button></Link>
